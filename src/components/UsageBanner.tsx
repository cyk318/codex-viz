    ...
    >
      <div className="grid gap-4 p-5 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
        <div>
          ...
          <div className="mt-1 text-2xl font-semibold text-slate-950 dark:text-slate-50">Codex 使用概览</div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:min-w-[360px]">
          <div className="rounded border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
            ...
            <div className="mt-1 text-3xl font-semibold text-slate-950 dark:text-slate-50">{formatCompactNumber(usage.tokens)}</div>
          </div>
          <div className="rounded border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
            <div className="text-xs text-slate-500">预估费用</div>
            <div className="mt-1 text-3xl font-semibold text-slate-950 dark:text-slate-50">{formatUsd(usage.cost)}</div>
          </div>
        </div>
      </div>
    </Link>
